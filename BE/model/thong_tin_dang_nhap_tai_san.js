...
const ThongTinDangNhapTaiSan = sequelize.define('ThongTinDangNhapTaiSan', {
    thong_tin: {
        type: DataTypes.JSON,
        allowNull: false
    },
...
ThongTinDangNhapTaiSan.belongsTo(TaiKhoan, { as: 'NguoiDaiDien', foreignKey: 'nguoi_dai_dien_id' });
ThongTinDangNhapTaiSan.belongsTo(TaiKhoan, { as: 'NguoiNhan', foreignKey: 'nguoi_nhan_id' });
